      ...
      <div className="flex-[1.2] text-center md:text-left space-y-8 z-10 order-2 md:order-1">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tight">
            ...
            &nbsp;sohasini <br /> tajribali ustoz bilan o'rganing
          </h1>
        </div>

        <p className="text-gray-400 text-lg md:text-xl max-w-xl leading-relaxed">
          Arxitektura, samaradorlik va foydalanuvchi tajribasiga (UX) asoslangan
          zamonaviy veb-ilovalarni yaratish bo'yicha professional tajriba.
        </p>

        <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm font-medium text-gray-500 uppercase tracking-widest">
